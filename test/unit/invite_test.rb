...
class InviteTest < NodeTest
  ...
  test "invite many" do
    ...
    assert_messages_sent_to 1, T.invitations_sent_to_users(['User2', 'User3']), :group => 'Group1'
  end
  ...
  test "invite to other group" do
    ...
    assert_messages_sent_to 1, T.invitations_sent_to_users(['User2', 'User3']), :group => 'Group2'
  end
  ...
  test "invite non existing user" do
    ...
    assert_messages_sent_to 1, T.could_not_find_users_for_invitation('User3'), :group => 'Group1'
  end
  ...
  test "invite non existing users" do
    ...
    assert_no_invite_exists
    assert_messages_sent_to 1, T.could_not_find_users_for_invitation(['User3', 'User4']), :group => 'Group1'
  end
  ...
  test "invite new mobile number" do
    ...
    assert_messages_sent_to 1, T.invitations_sent_to_users('5591112345678'), :group => 'Group1'
  ...
  test "invite existing mobile number" do
    ...
    assert_invite_exists "Group1", "User2"
    assert_messages_sent_to 2, T.user_has_invited_you('User1', 'Group1')
    assert_messages_sent_to 1, T.invitations_sent_to_users('2'), :group => 'Group1'
  ...
  test "invite self" do
    ...
    assert_no_invite_exists
    assert_messages_sent_to 1, T.you_cant_invite_yourself, :group => 'Group1'
  end
  ...
  test "invite from many requestors" do
    ...
    assert_messages_sent_to 1..2, T.user_has_accepted_your_invitation('User3', 'Group1'), :group => 'Group1'
  ...
  test "invite many times same user" do
    ...
    assert_messages_sent_to 1, T.you_already_invited_user('User2', 'Group1'), :group => 'Group1'
  ...
  test "invite user that already belongs to group" do
    ...
    send_message 1, "invite User2"
    assert_messages_sent_to 1, T.user_already_belongs_to_group('User2', 'Group1'), :group => 'Group1'
    assert_no_messages_sent_to 2
  end
